...
#let contacttext(info, uservars) = block(width: 100%)[
    ...
    #pad(x: 0em)[
        #profiles.join([#sym.space.en #sym.circle.filled.small #sym.space.en])
    ]
]
        ...
        #for w in info.work {
            ...
            block(width: 100%)[
                ...
                *#link(w.url)[#w.organization]* #h(1fr) *#w.location* \
                ...
                // Highlights or Description
                #if w.keys().contains("highlights") and w.at("highlights") != none {
        ...
        #for project in info.projects {
            ...
            block(width: 100%)[
                ...
                *#link(project.url)[#project.name]* 
                // Line 2: Degree and Date Range
                 #if (project.affiliation != none) { text(style: "italic")[\ #project.affiliation]}  #h(1fr) \
